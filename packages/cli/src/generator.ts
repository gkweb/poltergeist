...
export function buildGhostMarkdown(input: GeneratorInput): string {
  ...
  // --- Tradeoff preferences (manual fill) ---
  lines.push(
  ...
  lines.push(
    ...
    "",
    "_[Fill in manually — e.g.: **shared-mutable-state** (×1.8) — production incident. Amplifies: error_handling, readability]_",
    "",
  );

  // --- Ordinal ranked list (kept as fallback / readable summary) ---
  lines.push(
    "---",
    "",
    "## Review Philosophy",
